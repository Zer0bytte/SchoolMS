...
public sealed class Result<TValue> : IResult<TValue>
{
    ...
    [Obsolete("For serlizer only.", true)]
    ...
    private Result(List<Error> errors)
    {
        ...
        {
            throw new ArgumentException("Cannon create an ErrorOr<TValue> from an empty collection of errros." +
    ...
    public static implicit operator Result<TValue>(List<Error> value) => new(value);
}
