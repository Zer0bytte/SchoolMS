...
public static class SubmissionErrors
{
    ...
    public static Error FileUploadFailed => Error.Failure("Submission.FileUpload.Failed", "Failed to upload the file.");
    ...
    public static Error AlreadySubmitted => Error.Conflict("Assignment.AlreadYSubmitted", "You already submitted this assignment.");
}